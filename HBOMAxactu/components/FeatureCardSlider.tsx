...
function productionDate(project: ProductionProject) {
  ...
  return project.release_year ? project.release_year.toString() : "Date a confirmer";
}
    ...
    return (
      <section className="mx-auto max-w-[1500px] px-4 py-5 sm:px-6">
        <div className="max-w-4xl rounded-lg border border-white/10 bg-white/[0.045] p-6">
          <p className="text-[11px] font-medium uppercase tracking-[0.24em] text-max-cyan">Selection</p>
  ...
  return (
    <section className="mx-auto max-w-[1500px] px-4 py-5 sm:px-6">
      <div className="mb-3 flex items-end justify-between">
        <div>
          <p className="text-[11px] font-medium uppercase tracking-[0.24em] text-max-cyan">A suivre</p>
          <h1 className="mt-1.5 text-xl font-black md:text-2xl">Productions et actualites en vue</h1>
        </div>
        <p className="hidden text-xs text-white/45 md:block">Faire defiler les cartes</p>
      </div>
