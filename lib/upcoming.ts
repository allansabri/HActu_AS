...
// Add demo sport events
demoUpcomingReleases.push(
  {
    id: "demo-upcoming-sport-foot",
    title: "Ligue des Champions - Finale",
    slug: "ligue-des-champions-finale",
    type: "sport",
    synopsis: "La grande finale de la Ligue des Champions en direct sur Max.",
    release_label: "Événement live",
...
function normalizeType(value?: string | null): ContentType | "all" {
  return value === "movie" || value === "series" || value === "documentary" || value === "special" || value === "sport" ? (value as ContentType) : "all";
}
