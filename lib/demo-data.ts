...
export const demoArticles: Article[] = [
  {
    ...
    title: "The Last of Us saison 3 : ce que Max peut déjà préparer",
    slug: "the-last-of-us-saison-3-ce-que-max-peut-deja-preparer",
    content:
      "Après une deuxième saison très surveillée, The Last of Us reste l’une des marques fortes de HBO. La suite devrait continuer à mélanger récit intime, survie et grandes séquences de tension.\n\nPour Max, l’enjeu est clair : garder l’événement vivant entre deux saisons avec bandes-annonces, entretiens, récapitulatifs des épisodes et dossiers sur les personnages. C’est exactement le type de contenu qui peut nourrir une page actualité comme celle-ci.\n\nCette fiche utilise des visuels TMDB pour donner un rendu proche d’un vrai site éditorial.",
    excerpt:
      "La série HBO reste un pilier de Max : calendrier, personnages et attentes, voici le type d’article qui peut alimenter le site.",
  ...
  },
  {
    ...
    content:
      "House of the Dragon installe une guerre de succession où chaque alliance compte. Les familles, les dragons et les choix politiques donnent au prequel une identité plus resserrée que Game of Thrones.\n\nUn site HBO Max peut transformer chaque annonce en dossier : résumé de saison, carte des camps, analyse des personnages et suivi de production. Les fiches TMDB servent ici de base visuelle pour donner de la profondeur au rendu.\n\nL’objectif de cette démo est de montrer comment une actualité longue apparaît avec image hero, chapô et paragraphes.",
    excerpt:
  ...
  },
  {
    ...
    content:
      "The Batman reste l’un des titres DC les plus identifiables du catalogue Warner. Son ambiance détective, sa Gotham plus urbaine et son casting en font un bon point d’entrée pour une collection dédiée.\n\nSur le site, ce type d’article peut renvoyer vers une fiche titre, une collection DC, une bande-annonce et des dossiers de production. Les images viennent de TMDB afin de donner un rendu proche d’une vraie publication.\n\nLa structure permet aussi de tester les cartes d’actualités, les pages détail et les blocs vidéo.",
    excerpt:
      "Avec son Gotham noir et son approche détective, The Batman donne une bonne base pour tester les articles cinéma.",
  ...
  },
  {
    ...
    title: "Dune : Deuxième partie rejoint les incontournables science-fiction",
    slug: "dune-deuxieme-partie-rejoint-les-incontournables-science-fiction",
    content:
      "Dune : Deuxième partie confirme l’ampleur visuelle de la saga et son importance dans le catalogue Warner. C’est le type de film qui fonctionne à la fois en nouveauté, en recommandation et en dossier thématique.\n\nPour un média spécialisé Max, le sujet peut être décliné en critique, guide de visionnage, focus sur les personnages ou article sur les coulisses. La page sert ici à tester un rendu riche avec image grand format et texte éditorial.\n\nCes données sont des contenus de démonstration et peuvent ensuite être remplacées par les vraies publications du back-office.",
    excerpt:
      "Un exemple d’article cinéma pour tester les cartes, les catégories et les pages détail avec un visuel fort.",
