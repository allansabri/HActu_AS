...
function payloadFromTmdb(
  ...
  const sourceNote = `Synchronisation TMDB ${source.label}. Les statuts de production précis (pré-production, tournage, post-production) doivent être validés depuis une source production autorisée.`;
